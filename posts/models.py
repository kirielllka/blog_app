...
class Comments(models.Model):
    ...
    date_of_create = models.DateTimeField(auto_now_add=True,
                                          verbose_name='Date of create')  # устанавливается при создании
    date_of_edit = models.DateTimeField(auto_now=True,
                                        verbose_name='Date of edit')  # устанавливается при изменениии только
...
class Likes(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, verbose_name='post', related_name='likes_post', blank=True,
                             null=True)
    comment = models.ForeignKey(Comments, on_delete=models.CASCADE, verbose_name='comment',
                                related_name='likes_comment', blank=True, null=True)
